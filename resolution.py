...
parser.add_argument("-q", "--quest", metavar="", type=int, required=True,
                    help="Número das questões de 1 a 13")
...
class ResolvedQuestions():
    """
    Está classe fornece soluções para as questões propostas.

    `Atributos:`
        arr1: NumPy Array de uma dimensão
        mat1: NumPy 3x3 Matriz como valores aleatórios entre 0 e 1

    `Metódos:`
        Todos os metodos criados nessa classe forcem as respostas para
        as questões do exercicío.
    """
    ...
    def question2(self):
        ...
        [DOC] `random_sample`: https://numpy.org/doc/stable/reference/random/generated/numpy.random.random_sample.html
    ...
    def question5(self):
        ...
        """
        array_element_x2 = [ i * 2 for i in self.arr1 ]
        return array_element_x2
    ...
    def question7(self):
        ...
        """
        determinant = np.linalg.det(self.mat1)
        return determinant
    ...
    def question11(self):
        ...
        """
        self.question10()
        filter = self.df.loc[self.df['Sexo'] == 'F']
        return filter
    ...
    def question12(self):
        ...
        """
        self.question10()
        order_by_age = self.df.sort_values('Idade', ascending=False)
        return order_by_age
    ...
    def question13(self):
        ...
        """
        self.question10()
        df_pivot = self.df.pivot_table(index='Nome', columns='Medicamento', values=['Idade', 'Sexo'], aggfunc='first')
        return df_pivot

def chose_question(quest_number):
    quest = ResolvedQuestions()

    # Preenchendo automaticamente o dicionário com as questões
    #options = {
    #   1: quest.question1,
    #   .....
    #   13: quest.question13
    ...
    if quest_number in options:
        ...
        # vai mostrar o enuciado da questão, se não, apenas executa a solução da questão
        output = options[quest_number].__doc__ if args.desc else options[quest_number]()
        return output

if __name__ == "__main__":
    output = chose_question(args.quest)
    print(output)
